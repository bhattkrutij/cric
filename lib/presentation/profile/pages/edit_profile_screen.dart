  ...
  Widget _nameController() {
    return BlocBuilder<EditProfileCubit, EditProfileState>(
      builder: (context, state) {
        ...
        return TextField(controller:_nameTextEditingController, decoration: InputDecoration(hintText: name, errorText: error),);
      },
    );
  }
   ...
   Widget _birthDayController() {
     return BlocBuilder<EditProfileCubit, EditProfileState>(
       builder: (context, state) {
         ...
         return TextField(controller:_birthDayTextEditingController, decoration: InputDecoration(hintText: birthDate, errorText: error),onTap: () async {
           ...
           if (picked != null) {
             _birthDayTextEditingController.text = DateFormat('yyyy-MM-dd').format(picked); // Format date as yyyy-MM-dd
